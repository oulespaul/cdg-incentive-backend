...
import com.cdg.cdg_incentive_backend.module.targetbranch.submodule.targetdmm.dto.response.TargetDMMResponse;
...
public class TargetBranchResponse {
    ...
    private Set<TargetDMMResponse> targetDMMList;
}
